...
import quotesAdminRoutes, { publicQuotesRouter, agencyQuotesRouter } from './routes/quotesAdmin.js';
...
app.use('/api/formation-availability', formationAvailabilityPublic);
