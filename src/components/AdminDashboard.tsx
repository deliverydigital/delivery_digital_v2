                ...
                <div className="flex-1 p-8">
                    ...
                    {activeTab === 'training' && (
                        <div className="text-center py-12 bg-gray-800 rounded-lg">
                            ...
                            <h3 className="text-lg font-medium text-white mb-2">Gestion des Formations</h3>
                            <p className="text-gray-400">Fonctionnalité de gestion des formations à venir.</p>
                        </div>
                    )}
